...
class TreeCoverBaseline(BaseModel):
    ...
    county = models.ForeignKey(
        County, related_name="tree_cover_baselines", on_delete=models.CASCADE
    )
...
class DeforestationAlert(BaseModel):
    ...
    county = models.ForeignKey(
        County, related_name="deforestation_alerts", on_delete=models.CASCADE, null=True, blank=True
    )
