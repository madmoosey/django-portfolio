...
class TreeCoverBaselineSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'county', 'county_name', 'state_abbreviation', 
            'year', 'tree_cover_percent', 'tree_cover_area_ha', 
...
class TreeCoverLossSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'county', 'county_name', 'state_abbreviation', 
            'year', 'loss_area_ha', 'loss_percent', 'primary_driver',
...
class DeforestationAlertSerializer(GeoFeatureModelSerializer):
    ...
    class Meta:
        ...
        geo_field = 'location'
        fields = [
            'id', 'alert_date', 'confidence', 'county_name', 'state_abbreviation',
            'alert_type', 'area_ha', 'created_at'
        ]
