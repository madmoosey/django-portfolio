...
api_v1_router.register(r"deforestation/baselines", TreeCoverBaselineViewSet, basename="treecoverbaseline")
api_v1_router.register(r"deforestation/loss", TreeCoverLossViewSet, basename="treecoverloss")
api_v1_router.register(r"deforestation/alerts", DeforestationAlertViewSet, basename="deforestationalert")
